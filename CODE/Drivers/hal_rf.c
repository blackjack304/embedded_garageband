...
/* TX power values */
#define CC2430_TXPOWER_0_DBM   0x06
#define CC2430_TXPOWER_13_DBM  0x13
#define CC2430_TXPOWER_15_DBM  0x17
#define CC2430_TXPOWER_18_DBM  0x5F
#define CC2430_TXPOWER_19_DBM  0xFF

#elif INCLUDE_PA==2590
/* TX power lookup index */
#define HAL_RF_TXPOWER_MIN_13_DBM 0
#define HAL_RF_TXPOWER_MIN_3_DBM  1
#define HAL_RF_TXPOWER_5_DBM      2
#define HAL_RF_TXPOWER_10_DBM     3
#define HAL_RF_TXPOWER_11_DBM     4

#define CC2430_TXPOWER_MIN_13_DBM 0x63
#define CC2430_TXPOWER_MIN_3_DBM  0x87
#define CC2430_TXPOWER_5_DBM      0x13
#define CC2430_TXPOWER_10_DBM     0x5F
#define CC2430_TXPOWER_11_DBM     0xFF
#endif
...
/* TX power values */
#define CC2430_TXPOWER_0_DBM       0x5F
#define CC2430_TXPOWER_MIN_4_DBM   0x17
...
#elif INCLUDE_PA==2590
  "-13 dBm", HAL_RF_TXPOWER_MIN_13_DBM,
  "-3 dBm",  HAL_RF_TXPOWER_MIN_3_DBM,
  "5 dBm",   HAL_RF_TXPOWER_5_DBM,
  "10 dBm",  HAL_RF_TXPOWER_10_DBM,
  "11 dBm",  HAL_RF_TXPOWER_11_DBM
#endif
};
#else
static const menuItem_t pPowerSettings[] =
